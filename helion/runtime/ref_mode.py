...
class RefModeTorchFunctionMode(BaseTorchFunctionMode):
    ...
    def __init__(self) -> None:
        ...
        self._func_handlers = {
            ...
            torch.Tensor.expand: lambda args, kwargs: self._handle_view_method(
                args, kwargs, "expand"
            ),
            torch.Tensor.view: lambda args, kwargs: self._handle_view_method(
                args, kwargs, "view"
            ),
    ...
    def _handle_view_method(
        ...
        # convert_size_arg returns a list when given a tuple/list
